...
function documentActions(e) {
  ...
  if (window.innerWidth > 768 && isMobile.any()) {
    ...
    if (!targetElement.classList.contains("menu__btn") && document.querySelectorAll(".menu__item._active").length > 0) {
      _removeClasses(document.querySelectorAll(".menu__item._active"), "_active");
    }
  }
  if (window.innerWidth < 768 && isMobile.any()) {
  ...
  if (targetElement.classList.contains("footer__scroll")) {
    window.scrollTo({ top: 0, behavior: "smooth" });
  }
  if (targetElement.closest(".card")) {
    _removeClasses(document.querySelectorAll(".card._card-active"), "_card-active");

    targetElement.closest(".card").classList.toggle("_card-active");
  }
  if (!targetElement.closest(".card") && document.querySelectorAll(".card._card-active").length > 0) {
    _removeClasses(document.querySelectorAll(".card._card-active"), "_card-active");
  }
}
